...
<div id="banner">
    ...
    <hr>  <h2  id="h1" style="color: black"> <center>About Us</center></h2> <hr>
      <marquee direction="up" align="right"><h2 style="text-align:center ">The objective of this application is to automate the details of transportation 
		 ...
		 the administrator to maintain and update all information of cab details. The vehicle are assigned
		 by administrator to user vehicle request. This system allows user to make complaint for service and
